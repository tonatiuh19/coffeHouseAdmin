...
function sendmail($addReplyToEmail, $provider, $trackId)
{
    ...
    $mess =
        ...
        $trackId .
        '</td></tr></table><table cellspacing="0" cellpadding="0" width="100%"><tr><td style="padding-top:35px"><table cellpadding="0" cellspacing="0" width="100%"><tr><td width="350" class="mobile-hide" style="vertical-align:top">Cualquier duda que tengas no dudes en contestar este correo.<br><h4>Equipo BolsaDeCafe<h4></td><td style="padding:0 0 15px 30px" class="mobile-block"></td></tr><tr><td style="vertical-align:top" class="desktop-hide">Cualquier duda que tengas no dudes en contestar este correo.<br><h4>Equipo BolsaDeCafe<h4></td></tr></table></td></tr></table></td></tr></table></center></td></tr><tr><td style="background-color:#1f1f1f"><center><table border="0" cellpadding="0" cellspacing="0" width="600" class="w320" style="height:100%;color:#fff" bgcolor="#1f1f1f"><tr><td align="right" valign="middle" class="mobile-padding" style="font-size:12px;padding:20px;background-color:#1f1f1f;color:#fff;text-align:left"></td></tr></table></center></td></tr></table></td></tr></table></body></html>';
